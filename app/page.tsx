          ...
          <div className="grid gap-0 sm:gap-8 grid-cols-12">
            ...
            <div className="col-span-12 sm:col-span-5 lg:col-span-3 text-2xl overflow-clip mt-2 lg:mt-0">
                <ul>
                  ...
                  <li>
                    <a href="/PortfolioNext/cv.pdf" download="cv_marcin_kostrzemski" className="group bg-neutral-950 text-primary w-full mt-2 uppercase hover:bg-primary hover:text-neutral-950 flex items-center justify-center">
